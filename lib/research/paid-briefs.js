...
export function paidBriefKey(serverUrl, accountId, projectId) {
...
export function createFilePaidBriefStore(resolvePath) {
    const load = () => {
        try {
...
/** 内存存储（离线测试用）。 */
export function createMemoryPaidBriefStore(seed = {}) {
    const table = { ...seed };
    return {
...
//# sourceMappingURL=paid-briefs.js.map