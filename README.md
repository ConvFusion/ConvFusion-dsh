...
<p align="center">
  <img src="https://img.shields.io/badge/version-v0.4.2-4a43ea" alt="Version 0.4.2">
...
- **专业技能库**：内置 55 个经过验证的研究方法技能，分 9 类（理解输入 · 文献调研 · 创新假设 · 研究计划 · 资源估计 · 研究决策 · 实验验证 · 论文写作 · 工作评阅），覆盖文献综述、实验设计（含硬件不足时先出仿真结果）、结果分析、论文写作等科研全流程
